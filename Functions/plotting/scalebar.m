...
classdef scalebar <handle
	...
	methods
		function hobj = scalebar(varargin)                        
			...
			templine = plot([0 0],[0 0],'Parent',hAxes,'Color',hobj.Color,'LineWidth',2.5);
			...
			hobj.hTextX = text(0,0,'','Color',hobj.Color, 'FontSize', 12, 'Parent',hAxes,'ButtonDownFcn',@hobj.FcnStartDrag);
			hobj.hTextY = text(0,0,'','Color',hobj.Color, 'FontSize', 12, 'Parent',hAxes,'Rotation',90,'ButtonDownFcn',@hobj.FcnStartDrag);
