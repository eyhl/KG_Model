...
% [intD(1), meanD(1), areas(1), eleData1, ~] = integrateOverDomain(md, thinning, surf>1000 | mask);
% [intD(2), meanD(2), areas(2), eleData2, ~] = integrateOverDomain(md, thinning, surf<1000 | surf>1500 | mask);
% [intD(3), meanD(3), areas(3), eleData3, ~] = integrateOverDomain(md, thinning, surf<1500 | surf>2000 | mask);
% [intD(4), meanD(4), areas(4), eleData4, ~] = integrateOverDomain(md, thinning, surf<2000 | surf>2500 | mask);
% [intD(5), meanD(5), areas(5), eleData5, ~] = integrateOverDomain(md, thinning, surf<2500 | mask);
...
[intD(1), meanD(1), areas(1), eleData1, eleArea1] = integrateOverDomain(md, thinning, surf>1000 | mask);
[intD(2), meanD(2), areas(2), eleData2, eleArea2] = integrateOverDomain(md, thinning, surf<1000 | surf>1500 | mask);
[intD(3), meanD(3), areas(3), eleData3, eleArea3] = integrateOverDomain(md, thinning, surf<1500 | surf>2000 | mask);
[intD(4), meanD(4), areas(4), eleData4, eleArea4] = integrateOverDomain(md, thinning, surf<2000 | surf>2500 | mask);
[intD(5), meanD(5), areas(5), eleData5, eleArea5] = integrateOverDomain(md, thinning, surf<2500 | mask);
disp('pause')
pause
% save section data as file 
